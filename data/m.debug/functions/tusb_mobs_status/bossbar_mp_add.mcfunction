...
execute as @a[tag=m.view_MP] at @s store result bossbar mars:tusb_status_mp value run scoreboard players get @e[tag=Mob,sort=nearest,limit=1,tag=m.mob_view,scores={MP=0..}] MP
